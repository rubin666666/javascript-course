...
├── ⚡ QUICKSTART.md                # ← Швидкий старт за 30 секунд
├── ❓ FAQ.md                       # ← Часті питання та troubleshooting
├── 📋 RESOURCES.md                 # ← Повний довідник всіх ресурсів
...
| № | Урок | Файл | Опис | Час |
|---|------|------|------|-----|
| 1 | **Змінні та типи даних** | `01-variables.js` | let, const, var, типи даних, typeof | 45 хв |
| 2 | **Оператори** | `02-operators.js` | Арифметичні, порівняння, логічні, присвоєння | 60 хв |
| 3 | **Умовні конструкції** | `03-conditions.js` | if/else, switch/case, тернарний оператор | 45 хв |
| 4 | **Цикли** | `04-loops.js` | for, while, do-while, for-in, for-of, break/continue | 60 хв |
| 5 | **Функції** | `05-functions.js` | Оголошення, стрілкові, callback, замикання, рекурсія | 90 хв |
| 6 | **Масиви** | `06-arrays.js` | Створення, методи map/filter/reduce, сортування | 75 хв |
| 7 | **Об'єкти** | `07-objects.js` | Створення, методи, деструктуризація, геттери/сеттери | 75 хв |
...
- 📄 **README.md** (цей файл) - загальний огляд курсу та інструкції
- 📄 **js-basics/README.md** - детальний опис всіх 7 уроків
- 📄 **DOCUMENTATION.md** - технічна документація для розробників  
- ⚡ **QUICKSTART.md** - швидкий старт за 30 секунд
- ❓ **FAQ.md** - часті питання та troubleshooting
- 📋 **RESOURCES.md** - повний довідник всіх ресурсів проекту
